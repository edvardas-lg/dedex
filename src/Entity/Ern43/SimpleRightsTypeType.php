...
class SimpleRightsTypeType
{
    ...
    /**
     * The Namespace of the SimpleRightsType. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the SimpleRightsType. This is represented in an XML schema as an XML Attribute.
     *
