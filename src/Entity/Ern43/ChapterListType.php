...
class ChapterListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern43\ChapterType[] $chapter
     */
    private $chapter = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern43\ChapterType $chapter
     */
    public function addToChapter(\DedexBundle\Entity\Ern43\ChapterType $chapter)
    {
     ...
     * A Composite containing details of a Chapter contained in a Resource.
     *
     * @return \DedexBundle\Entity\Ern43\ChapterType[]
     */
