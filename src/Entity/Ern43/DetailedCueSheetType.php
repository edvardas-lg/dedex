...
class DetailedCueSheetType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern43\DetailedCueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DedexBundle\Entity\Ern43\DetailedCueType $cue
     */
    public function addToCue(\DedexBundle\Entity\Ern43\DetailedCueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     * A Composite containing details of a Cue.
     *
     * @return \DedexBundle\Entity\Ern43\DetailedCueType[]
     */
