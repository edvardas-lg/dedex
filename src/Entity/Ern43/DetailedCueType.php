...
class DetailedCueType
{
     ...
     * @return self
     */
    public function setCueUseType(\DedexBundle\Entity\Ern43\CueUseTypeType $cueUseType)
    {
     ...
     * @return self
     */
    public function setCueThemeType(\DedexBundle\Entity\Ern43\CueThemeTypeType $cueThemeType)
    {
     ...
     * @return self
     */
    public function setCueVocalType(\DedexBundle\Entity\Ern43\CueVocalTypeType $cueVocalType)
    {
     ...
     * @return self
     */
    public function setCueVisualPerceptionType(\DedexBundle\Entity\Ern43\CueVisualPerceptionTypeType $cueVisualPerceptionType)
    {
     ...
     * @return self
     */
    public function setCueOrigin(\DedexBundle\Entity\Ern43\CueOriginType $cueOrigin)
    {
     ...
     * @return self
     */
    public function setResourceId(\DedexBundle\Entity\Ern43\ResourceIdType $resourceId)
    {
     ...
     * @return self
     */
    public function setWorkId(\DedexBundle\Entity\Ern43\MusicalWorkIdType $workId)
    {
        $this->workId = $workId;
        return $this;
    }
