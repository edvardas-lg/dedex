...
class AdministratingRecordCompanyWithReferenceType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern43\AdministratingRecordCompanyRoleType $role
     */
    private $role = null;
     ...
     * The role played by the Party responsible for administering Rights in a Resource or a Release.
     *
     * @return \DedexBundle\Entity\Ern43\AdministratingRecordCompanyRoleType
     */
     ...
     * The role played by the Party responsible for administering Rights in a Resource or a Release.
     *
     * @param \DedexBundle\Entity\Ern43\AdministratingRecordCompanyRoleType $role
     * @return self
     */
    public function setRole(\DedexBundle\Entity\Ern43\AdministratingRecordCompanyRoleType $role)
    {
        $this->role = $role;
        return $this;
    }
